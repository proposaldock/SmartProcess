...
const useCaseSections = [
  ...
  {
    eyebrow: "E-post, leads och kundärenden",
    title: "När inkommande flöden borde vara enklare att prioritera och besvara",
    body: "Inkommande ärenden kan klassificeras, prioriteras och förberedas med rätt kontext så att mänsklig hantering används där den verkligen behövs.",
    examples: [
      "Prioritera inkommande frågor och leads direkt",
      "Ge teamet svarsutkast och rätt kontext snabbare",
      "Skicka vidare rätt ärenden utan manuell sortering",
    ],
    visualLabel: "Inkommande flöden",
    visualTitle: "Inkommande ärenden",
    visualMeta:
      "Frågor, leads och supportärenden prioriterade innan teamet tar över.",
    visualPill: "Prioritering aktiv",
    visualRows: [
      { label: "Prioritet", value: "Hög / medel / låg" },
      { label: "Föreslaget svar", value: "3 klara utkast" },
      { label: "Routing", value: "Rätt team valt" },
    ],
    visualFooter:
      "Mindre tid går till sortering och manuella överlämningar.",
    dark: true,
  },
  {
