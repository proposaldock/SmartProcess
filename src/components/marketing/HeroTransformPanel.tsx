  ...
  return (
    <div className="overflow-hidden rounded-[36px] bg-[linear-gradient(145deg,rgba(190,47,36,0.38)_0%,rgba(23,19,18,0.98)_50%,rgba(23,19,18,1)_100%)] bg-[var(--foreground)] p-6 shadow-[0_24px_64px_-20px_rgba(23,19,18,0.28)] sm:p-8">
      ...
      <div className="mt-7 space-y-0">
        ...
        <div className="py-5">
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-semibold uppercase tracking-[0.2em] text-white/35">02</span>
            <span className="text-[10px] font-semibold uppercase tracking-[0.2em] text-white/60">Build</span>
          </div>
          <h3 className="mt-2 text-base font-semibold tracking-tight text-white/90">
        ...
        <div className="pb-2 pt-5">
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-semibold uppercase tracking-[0.2em] text-white/35">03</span>
            <span className="text-[10px] font-semibold uppercase tracking-[0.2em] text-white/60">Optimize</span>
          </div>
          <h3 className="mt-2 text-base font-semibold tracking-tight text-white/90">
